...
public class NhanVien {
    ...
    public Object[] toRowData() {
        return new Object[]{this.id, this.ma, this.tenDem + " " + this.ho + " " + this.ten, this.gioiTinh, this.ngaySinh, this.diaChi, this.sdt, this.matKhau, this.idCH, this.idCV, this.idGuiBC, this.trangThai};
    }
}
